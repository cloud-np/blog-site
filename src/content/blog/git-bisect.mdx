...
import siteWorking from "../../assets/git-bisect/site-working.png";
import siteBroken from "../../assets/git-bisect/site-broken.png";
import differences from "../../assets/git-bisect/differences.png";
...
#### Our good state
<Image src={siteWorking} alt="the site working initially" style={"width: 100%"} />
...
<Image src={siteBroken} alt="the site that is now broken" style={"width: 100%"} />

We notice that there are two new bugs appearing compared to the old version:
<Image src={differences} alt="differences" style={"width: 100%"} />
