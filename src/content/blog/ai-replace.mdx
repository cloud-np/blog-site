...
boost and extra velocity coming from AI geenrated code is translated into poor quality
and an amalgamation of all sorts issues such as:
* low quality
* "bad taste" code
...
(fear of missing out) or because we actually managed be more productive with it to a certain degree.
...
The code quality could take a hit but who cares? I mean technically given enough tokens/iterations maybe either by pure chance
...
Sure, lets even assume development time increases in some cases but we didn't have to think much to achieve that outcome.
