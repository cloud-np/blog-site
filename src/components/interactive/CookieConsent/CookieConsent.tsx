...
const Buttons = component$(() => {
    return (<div class={`cookie-buttons`}>
        <button
...
export const CookieConsent = component$(() => {
    ...
    return (
        <div id="cookie-consent" class={[
            ...
            <div class="cookie-content transition-all ease-in duration-300 p-4 justify-around items-center gap-4">
                <p class={["transition-all duration-300 text-center mx-12 ", state.isPreferenceActive ? 'hidden' : '']}>
                ...
                <div class={[
                    ...
                    state.isPreferenceActive ? 'opacity-100 max-h-full' : 'opacity-0 max-h-0 overflow-hidden'
                ]}>
