import { $, component$, type QRL, useStore, useStylesScoped$, useVisibleTask$ } from '@builder.io/qwik';
...
interface ButtonsProps {
    onPreference$: QRL<() => void>;
    onReject$: QRL<() => void>;
    onAccept$: QRL<() => void>;
}

const CookieButtons = component$<ButtonsProps>(({ onPreference$, onReject$, onAccept$ }) => {
    return (
...
export const CookieConsent = component$(() => {
    ...
    const state = useStore({isVisible: false, isPreferenceActive: true, currentPath: "" });
        ...
        <div class={[
            ...
            <div class={["cookie-normal cookie-banner rounded-full",
                ...
                <div class="cookie-content p-4 justify-around items-center gap-4">
                    ...
                    <CookieButtons onPreference$={handlePreference$} onReject$={handleReject$} onAccept$={handleAccept$} />
                </div>
            </div>
            <div class={[
