...
export const CookieConsent = component$(() => {
    ...
    useVisibleTask$(() => {
        ...
        const handleNavigation = () => {
            ...
            console.log('handleNavigation with isVisible:', state.isVisible, 'nav:', navigationCounter.value);
            // init();
        };
    ...
    console.log('Rendering with isVisible:', state.isVisible, 'nav:', navigationCounter.value);
